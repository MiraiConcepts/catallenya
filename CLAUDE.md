...
bash syncthing/tests/run.sh                     # offline suite (path safety, state machine)
...
`capture.triage.sh` and `documents.intake.classify.sh`. Requests carry **no `tools` key** —
